        ...
        sec03.innerHTML += `
            <div class="w-auto h-[401px] ">
                ...
                <div class=" w-full h-auto bg-[#F6F6F6] relative rounded-[5px] !mb-[8px] overflow-hidden  ">
                    ...
                    <div class=" w-[63px] h-[31px] bg-[#9CDABC] rounded-[5px] flex justify-center items-center font-[f01] text-[#333333] absolute  top-[15px] left-[15px] z-[1] ">
                        ${elem.new}
                    </div>
                ...
                <div class="money">
                    <span class="w-full text-[#DB3F07] font-[f01] text-[14px] !mr-[10px]  " > ${elem.money} </span>

                    <span class="w-full font-[f02] text-[#666666] text-[14px] !line-through  " > ${elem.realmoney} </span>
